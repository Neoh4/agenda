 ...
 */
class getHomeworkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HomeworkRepository' shared autowired service.
     *
     * @return \App\Repository\HomeworkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HomeworkRepository.php';

        return $container->privates['App\\Repository\\HomeworkRepository'] = new \App\Repository\HomeworkRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
